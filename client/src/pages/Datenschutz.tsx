  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12 pt-32 max-w-4xl">
        <h1 className="text-3xl sm:text-4xl font-bold mb-8 break-words">Datenschutzerklärung</h1>
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          ...
          <section>
            ...
            <p>
              Beautylounge bei Jennifer Tevs<br />
              Zur Kupfermühle 8<br />
              49504 Lotte
            </p>
            <p>
              Telefon: <a href="tel:+491727556153" className="text-primary hover:underline">+49 172 7556153</a><br />
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6">Widerspruchsrecht gegen die Datenerhebung in besonderen Fällen sowie gegen Direktwerbung (Art. 21 DSGVO)</h3>
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6">Auskunft, Sperrung, Löschung und Berichtigung</h3>
            <p>
            ...
            <h3 className="text-xl font-semibold mb-3 mt-6">Widerspruch gegen Werbe-E-Mails</h3>
            <p>
